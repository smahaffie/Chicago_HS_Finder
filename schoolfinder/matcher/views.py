# Synethesize inputs from Django web interface and feed into Django template 
# generator
# Modified: general structure was generated by Django
...
from .get_neighborhood_schools import get_neighborhood_schools, \
    get_id_from_name, name_to_id
...
def form(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            #If SQL query page fails, we redirect to a page that avoids the 
            # Django error page and asks the user to try again
            ...
            if tier != None:
                rank_dict = rank_results(result_dict,form.cleaned_data,tier,
            ...
            context['map_info'].append(["Your address",user_lat,user_lng,"#"])
