...
This code is original with some documentation referenced for the subprocess commands
'''
...
def clean_data(collenrollpersist_filename, act_filename, freshontrack_filename, mainhs_filename, combohs_filename, optionshs_filename):
    '''
    Contains all the commands to clean the main school data csvs required to build the data base
